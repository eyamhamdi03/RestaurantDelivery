    ...
    <?php include ('nav.php');?>
        ...
        <div class="frame">
            ...
            <div class="layout">
                ...
                <input class="inpu" type="text" name="Street" size="15" maxlength="30"> <Br><Br>
                </div>
                <div class="name">
                 <span class="typo"> Apt/Suite/Other:</span><br>
                  <input class="inpu" type="text" name="Apt" size="15" maxlength="30"> <br><br>
                </div>
              </div>
              <div class="layout">
                <div class="name">
                  <span class="typo">State/City</span><br>
                <input class="inpu" type="text" name="State" size="15" maxlength="30"> <Br><Br>
                </div>
                <div class="name">
                 <span class="typo"> Code Postal:</span><br>
                  <input class="inpu" type="text" name="code" size="15" maxlength="30"> <br><br>
                </div>
              </div>
        </div>
        <div id="frame2">
